...
const VALID_PAGES = new Set(['home','brain','analysis','coach','records','growth','guardian','settings','analytics']);
...
export default function App(){
  ...
  const PageComponent={home:Home,brain:Brain,analysis:Analysis,coach:Coach,records:Records,growth:Growth,guardian:Guardian,settings:Settings,analytics:AnalyticsAdmin}[page] || Home;
