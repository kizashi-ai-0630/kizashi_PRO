...
export default function Settings(){
  ...
  return <Page title="管理" sub="公開準備・利用環境・トレードルールを整えます">
    <div className="release-banner"><div><small>KIZASHI 9.14 · TRADE IMPORT GUIDE BETA</small><h2>🚀 本番公開に向けて準備中</h2><p>現在はβ版です。
正式公開に向けて、機能の追加や改善を進めています。</p></div><span>β</span></div>
