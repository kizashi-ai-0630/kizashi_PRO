...
export default function Settings(){
  ...
  return <Page title="管理" sub="公開準備・利用環境・トレードルールを整えます">
    <div className="release-banner"><div><small>KIZASHI 9.15 · MOBILE IMPORT BETA</small><h2>🚀 本番公開に向けて準備中</h2><p>現在はβ版です。正式公開に向けて、機能の追加や改善を進めています。</p></div><span>β</span></div>
    <div className="settings-grid settings-grid-95">
      ...
      <section className="settings-card"><h2>データ管理</h2><p className="settings-note">現在のデータはブラウザ内に保存されます。ブラウザの削除や端末変更では引き継がれません。</p><button className="danger" onClick={reset}>ローカルデータを初期化</button></section>
